...
phoneListTable = ttk.Treeview(frame,columns=("name", s"phone"),show="headings")
...
phoneListTable.insert("", 0, text="First", values=("John", "123-456-
7890"))
phoneListTable.insert("", 1, text="Second", values=("Mary", "123-
456-7890"))
phoneListTable.insert("", 2, text="Third", values=("July", "123-456-
7890"))
phoneListTable.grid(column=0, row=3, columnspan=3, sticky=(N, W, E, 
S))
root.mainloop()